...
export function ThemePicker({ selectedTheme, onChange, disabled }: ThemePickerProps) {
  return (
    <>
      {/* Desktop: Visual Grid */}
          ...
          return (
            <button
              ...
              className={`
                ...
                ${isSelected ? 'ring-4 ring-white scale-105' : 'ring-2 ring-white/20 hover:ring-white/50 hover:scale-102'}
